...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Green>discord.gg/zxDnqEcw<Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Green>さま┊Windy•Hub Beta<Color=/>"):Display()
    wait(.14)
...
local Window = OrionLib:MakeWindow({Name = "さま┊Windy•Hub", HidePremium = false, IntroText = "さま┊Windy•Hub", SaveConfig = true, ConfigFolder = "Windy Hub"})

OrionLib:MakeNotification({
	Name = "さま┊Windy•Hub",
	Content = "Please Select Team",
	Image = "rbxassetid://17490596417",
	Time = 7
})
...
M:AddParagraph("Mastery Menu","Fuck Function MRT")
...
M:AddToggle({
    Name = "Kaitun In Main ( Not Have Kill Player )",
    Default = false,
    Flag = "Kaitun",
    Save = true,
    Callback = function(Value)

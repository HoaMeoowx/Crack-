...
mainFrame.Size = UDim2.new(0.3, 0, 0.3, 0)  -- Kích thước: 30% chiều rộng và cao màn hình
mainFrame.Position = UDim2.new(0.35, 0, 0.35, 0)  -- Giữa màn hình
...
title.Size = UDim2.new(1, 0, 0.2, 0)  -- Chiếm 20% khung trên
title.BackgroundTransparency = 1
title.Text = "New GUI Title"
title.TextColor3 = Color3.fromRGB(255, 255, 255)
title.Font = Enum.Font.SourceSans
title.TextScaled = true

-- Gui Function (MakeDraggable)
...
-- Áp dụng MakeDraggable lên GUI mới

...
function GetUi() 
    if getgenv().Tvk then
    if game.CoreGui:FindFirstChild("Windy Hub GUI") then
        for a, v in ipairs(game.CoreGui:GetChildren()) do
            if v.Name == "Windy Hub GUI" then
                v:Destroy()
            end
        end
    end
...
u.NotiGui.Name = "さま┊ᴡɪɴᴅʏ•ʜᴜʙ Notification"
...
-- end
-- local s,Translated = pcall(function() 
--     return game.HttpService:JSONDecode(readfile("Windy Hub/!UIText.json"))
-- end)
-- function SaveFile() 
--     pcall(function() 
--         writefile("Windy Hub/!UIText.json",game.HttpService:JSONEncode(getgenv().TranslateCache))
--     end)
-- end
...
--                         return
--                     end
--                     if string.match(des.Text,"Windy Hub") then 
--                         local tvk = des.Text:gsub("Windy Hub","Trung Tâm Biển")
--                         des.Text = tvk
--                         return
--                     end
--                     local old = des.Text
...
local Main = Library.CreateMain({Title = 'さま┊ᴡɪɴᴅʏ•ʜᴜʙ', Desc = '- Blox Fruit'})

local G = Main.CreatePage({Page_Name = 'Farming Tab', Page_Title = ''})
local IQ = Main.CreatePage({Page_Name = 'Sub Farming Tab', Page_Title = ''})
local DR = Main.CreatePage({Page_Name = 'Fruit and Raids', Page_Title = ''})
local STT = Main.CreatePage({Page_Name = 'Status and Servers', Page_Title = ''})
local PV = Main.CreatePage({Page_Name = 'Local Players Tab', Page_Title = ''})
local RC = Main.CreatePage({Page_Name = 'Upgrade Race', Page_Title = ''})
local SE = Main.CreatePage({Page_Name = 'Sea Event Tab', Page_Title = ''})
local MSC = Main.CreatePage({Page_Name = 'Misc Tab', Page_Title = ''})
local ST = Main.CreatePage({Page_Name = 'Settings Tab', Page_Title = ''})
...
local FarmSection = G.CreateSection('Farming')
...
local FastAttackSection = ST.CreateSection('Fast Attack')
